...
def is_last_message_from_sender(chat_log, sender_name="Rohan Das"):
    ...
    # Step 1: Click on the chrome icon at coordinates (1055, 424)
pyautogui.click(1055, 424)

time.sleep(1)  # Wait for 1 second to ensure the click is registered
while True:
    time.sleep(5)
    # Step 2: Drag the mouse from (1055, 424) to (2815, 1520) to select the text
    pyautogui.moveTo(1055, 424)
    pyautogui.dragTo(2815, 15208, duration=2.0, button='left')  # Drag for 1 second

    # Step 3: Copy the selected text to the clipboard
    pyautogui.hotkey('ctrl', 'c')
    time.sleep(2)  # Wait for 1 second to ensure the copy command is completed
    pyautogui.click(1032, 486)
    ...
    if is_last_message_from_sender(chat_history):
        ...
        messages=[
            ...
            {"role": "system", "content": "Do not start like this [21:02, 12/6/2025] Rohan Das: "},
        ...
        # Step 5: Click at coordinates (1703, 1634)
        pyautogui.click(1703, 1634)
        time.sleep(1)  # Wait for 1 second to ensure the click is registered
